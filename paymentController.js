...
const testSavingsJob = async (req, res) => {
  try {
    await agenda.now("charge card", {
      form: {
        authorization_code: "AUTH_pqgwelhs9s",
        email: "amberuteogenerojoshua@gmail.com",
        amount: 20000,
      },
      plan: {
        plan: "Earli",
        balance: 0,
        frequency: "daily",
        startDate: "2022-09-29T23:00:00.000Z",
        endDate: "2023-03-29T23:00:00.000Z",
        status: "Active",
        card: "6336d6a3322e9e27ee1d0d2d",
        savingsTransaction: [],
        duration: "6 Months",
        amount: 200,
        childId: "6336d5c5322e9e27ee1d0d08",
        _id: "6336f45e5001d5ad4e1b2df9",
        createdAt: "2022-09-30T13:51:26.505Z",
        updatedAt: "2022-09-30T13:51:26.505Z",
        __v: 0,
      },
    });
